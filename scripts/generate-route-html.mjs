...
const routes = [
  ...
  {
    path: 'for-customers',
    title: 'Портативна електростанція для замовників - Армада Індастрі | Автономне живлення 1000 Вт·год',
    description: 'Портативна електростанція для будівництва, виїзних робіт та резервного живлення. LiFePO4, 1000 Вт·год, пікова потужність 2000 Вт, офіційний сервіс та підтримка в Україні.',
    keywords: 'портативна електростанція, автономне живлення, резервне живлення, LiFePO4 електростанція, електростанція для будівництва, power station Україна',
    ogTitle: 'Портативна електростанція для замовників - Армада Індастрі',
    ogDescription: 'Надійне автономне живлення для будівництва, виїзних робіт і резервного енергозабезпечення з офіційним сервісом в Україні.',
    ogImage: `${siteUrl}/og-image.png`,
    robots: 'noindex, nofollow',
    heading: 'Портативна електростанція для замовників',
    intro: 'Рішення для автономного живлення будівництва, польових виїздів і резервного енергозабезпечення з офіційною підтримкою в Україні.'
  },
  {
    path: 'contact',
