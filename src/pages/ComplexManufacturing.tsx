          ...
          <div className="max-w-4xl mx-auto">
            <Card className="p-6 md:p-8 shadow-2xl border-primary/20 bg-gradient-to-br from-card to-background">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* Параметри проекту - всі необов'язкові */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-foreground flex items-center gap-2">
                      Тип проекту (необов'язково)
                    </label>
                    <select
                      name="projectType"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-foreground flex items-center gap-2">
                      Термін виконання (необов'язково)
                    </label>
                    <select
                      name="deadline"
                ...
                <div className="space-y-2">
                  <label className="text-sm font-medium text-foreground flex items-center gap-2">
                    ...
                    Креслення, ескізи або технічне завдання (необов'язково)
                  </label>
