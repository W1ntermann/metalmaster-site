        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card className="p-6 text-center bg-gradient-metal border-border">
              ...
              <div className="text-foreground font-medium mb-1">Якість покриття</div>
              <div className="text-sm text-muted-foreground">Європейські стандарти</div>
            </Card>
            <Card className="p-6 text-center bg-gradient-metal border-border">
            ...
            <Card className="p-6 text-center bg-gradient-metal border-border">
              ...
              <div className="text-sm text-muted-foreground">Широка палітра RAL</div>
            </Card>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <Card className="overflow-hidden bg-card border-border shadow-card">
              <div className="relative h-48 bg-gradient-metal flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="text-foreground font-medium">Полімеризація</p>
                </div>
              </div>
              <div className="p-6">
                ...
                <div className="space-y-2 mb-4">
                  <div className="flex justify-between items-center text-sm">
                    ...
                    <span className="text-foreground font-medium">80 кВт</span>
                  </div>
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-muted-foreground">Робоча зона:</span>
                    <span className="text-foreground font-medium">6000×1200×2000 мм</span>
                  </div>
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-muted-foreground">Товщина покриття:</span>
                    <span className="text-foreground font-medium">40-150 мкм</span>
                  </div>
                </div>
            ...
            <Card className="overflow-hidden bg-card border-border shadow-card">
              ...
              <div className="p-6">
                ...
                <div className="space-y-2 mb-4">
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-muted-foreground">Стандарти:</span>
                    <span className="text-foreground font-medium">ISO</span>
                  </div>
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-muted-foreground">Контроль товщини:</span>
                    <span className="text-foreground font-medium">Так</span>
                  </div>
                  <div className="flex justify-between items-center text-sm">
                    <span className="text-muted-foreground">Технолог:</span>
                    <span className="text-foreground font-medium">Кваліфікований</span>
                  </div>
                </div>
                <div className="space-y-2">
                  <h4 className="text-sm font-semibold text-foreground flex items-center gap-1">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <Card className="p-6 text-center">
              ...
              <h3 className="font-semibold text-foreground mb-2">Шагрінь</h3>
              <p className="text-sm text-muted-foreground">Текстурована поверхня, стійка до подряпин</p>
            </Card>
          </div>
        </div>
      </section>
