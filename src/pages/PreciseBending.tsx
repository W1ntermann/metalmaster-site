  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const dataToSend = {
        ...
        length: formData.length || 'Не вказано',
        angle: formData.angle || 'Не вказано',
        quantity: formData.quantity || 'Не вказано',
        description: formData.description,
        service_type: 'precise_bending',
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="p-6 md:p-8 shadow-2xl border-primary/20 bg-gradient-to-br from-card to-background">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {/* Параметри згинання - всі необов'язкові */}
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-foreground flex items-center gap-2">
